...
class DotMinecraft:
    base: Path = Path.home() / '.minecraft'

    def __post_init__(self):
        # garantir que todos os diretórios básicos existam
        # após iniciar essa classe
        ensure_directory(self.mods)
        ensure_directory(self.resourcepacks)

    @property
    def mods(self):
        return self.base / 'mods'

    @property
    def resourcepacks(self):
        return self.base / 'resourcepacks'
