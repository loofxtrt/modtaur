...
@dataclass
class Dependency():
    #TEMP_slug: str       # não existe na api original
...
@dataclass
class Version():
    #TEMP_parent_slug: str # não existe na api original. é o slug do projeto que contém essa versão
...
class Context():
    ...
    #TEMPresolved: set[str] = field(default_factory=set)
